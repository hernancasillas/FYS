    ...
    <div class="body_bg">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <a href="#" class="btn_1 d-none d-sm-block">Watch YoungSith Live!</a>
                            <a href="#" class="btn_1 d-none d-sm-block">Watch Nefariousbtw Live!</a>
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="banner_text">
                            <div class="banner_text_iner">
                                ...
                                <p>With this tool, you will find the perfect Fortnite sens, just for you! Not Tfue's, not Ninja's, yours!</p>
        ...
        <section class="client_logo">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <input type="text" class="form-control" name="sens" id="sens" placeholder="Sens">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="sens" id="sens" placeholder="Max">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="sens" id="sens" placeholder="Min">
